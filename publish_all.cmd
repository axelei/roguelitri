...
del Publish\Roguelitri-linux-x64\fmod*.dll
dotnet publish -r osx-x64 -p:PublishSingleFile=true --self-contained true -o Publish/Roguelitri-osx-x64
copy Lib\osx-x64\* Publish\Roguelitri-osx-x64
del Publish\Roguelitri-osx-x64\fmod*.dll
dotnet publish -r osx-arm64 -p:PublishSingleFile=true --self-contained true -o Publish/Roguelitri-osx-arm64
copy Lib\osx-arm64\* Publish\Roguelitri-osx-arm64
del Publish\Roguelitri-osx-arm64\fmod*.dll
