...
rm Publish/Roguelitri-linux-x64/fmod*.dll
dotnet publish -r osx-x64 -p:PublishSingleFile=true --self-contained true -o Publish/Roguelitri-osx-x64
cp Lib/osx-x64/* Publish/Roguelitri-osx-x64
rm Publish/Roguelitri-osx-x64/fmod*.dll
dotnet publish -r osx-arm64 -p:PublishSingleFile=true --self-contained true -o Publish/Roguelitri-osx-arm64
cp Lib/osx-arm64/* Publish/Roguelitri-osx-arm64
rm Publish/Roguelitri-osx-arm64/fmod*.dll